    ...
    stages {
        ...
        stage('Prod-Deploy') {
            ...
            steps {
                ...
                sh "ssh -o StrictHostKeyChecking=no -l ec2-user 52.34.73.204 'docker run -itd -p 90:80 467290638204.dkr.ecr.us-west-2.amazonaws.com/my-jenkins-project:${env.BUILD_NUMBER}'"
